// import { apiGetDetailBlog } from 'apis/blog';
...
// const DetailBlog = () => {
//     const { bid, title } = useParams(); // Lấy blog ID từ URL
...
//             if (response.success) {
//                 setBlog(response.response); // Gán dữ liệu blog
...
//                         {/* Metadata */}
//                         <div className="flex flex-wrap items-center text-gray-600 text-sm lg:text-base space-x-6 mb-8">
//                             <span>
...
//                                 <span className="ml-2 lg:ml-3 text-lg lg:text-xl">Like (123)</span>
//                             </button>
...
//                                 <span className="ml-2 lg:ml-3 text-lg lg:text-xl">Dislike (12)</span>
//                             </button>
//                         </div>
//                     </div>
//                 </div>
...
//     const { bid, title } = useParams(); // Lấy blog ID từ URL
//     const [blog, setBlog] = useState(null); // Lưu trữ dữ liệu blog
//     const [likes, setLikes] = useState(0); // Lưu trữ số lượng like
//     const [dislikes, setDislikes] = useState(0); // Lưu trữ số lượng dislike
//     const [isLiked, setIsLiked] = useState(false); // Kiểm tra người dùng đã like chưa
//     const [isDisliked, setIsDisliked] = useState(false); // Kiểm tra người dùng đã dislike chưa
...
//                 // Kiểm tra xem người dùng đã like hoặc dislike chưa
...
//                 setLikes(response.data.response.likes.length);
//                 setIsLiked(true);
//                 setIsDisliked(false); // Hủy dislike nếu đã like
//             }
//         } catch (error) {
...
//     // Hàm xử lý khi người dùng nhấn "Dislike"
//     const handleDislike = async () => {
//         try {
//             const response = await apiDislikeBlog(bid);
//             if (response.data.success) {
//                 setDislikes(response.data.response.dislikes.length);
//                 setIsDisliked(true);
//                 setIsLiked(false); // Hủy like nếu đã dislike
//             }
//         } catch (error) {
