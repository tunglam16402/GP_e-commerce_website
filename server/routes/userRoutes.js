...
router.put('/changepassword', verifyAccessToken, Controllers.changePassword);
...
router.post('/send-mail-order-success', [verifyAccessToken], Controllers.sendOrderSuccessEmail);
